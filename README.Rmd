...
The following plots illustrate results from the carrier sentence task. These 
...
after palatals, we expect to observe differences in overall duration. Moreover, 
the absense of the pre-vocalic glide should also affect intensity measurements. 
Specifically, a more 'consonant-like' production (i.e., not a glide) should 
show lower intensity, whereas a more 'vowel-like' production should show higher 
intensity. Furthermore, we analyze the time course of intensity, rather than a 
specific time point, in order to see how the two environments differ as they 
