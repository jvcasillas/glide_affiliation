...
## Find file 23 > has 43 columns

csv_files <- dir_ls(here("data", "phase_2"), regexp = ".csv")
for (file in csv_files) {
  df <- read_csv(file)
  num_columns <- ncol(df)
  print(file)
}  
## file with 43 columns = 5ec81ba6c71d2b0f9add5de5_ga_syllabified_check_2023-05-04_17h22.45.784
## deleted column entitled "trials.order" and row 160 = "230" 


--------------------
##############
######
###### copied "05a_analysis_syllabified.R
######
##############
...
saveRDS(glide_cri, here("tables", "tab_multi_cri_ph2.rds"))
saveRDS(glide_i_cri, here("tables", "tab_multi_i_cri_ph2.rds"))
saveRDS(glide_u_cri, here("tables", "tab_multi_u_cri_ph2.rds"))

# -----------------------------------------------------------------------------

######
###
### needs package to run anaysis
...
ggsave(
  filename = "syllabification_all_Feb24.png", 
...
bind_rows(
  ...
  saveRDS(., file = here("tables", "tab_multi_all_Dec23.rds"))
