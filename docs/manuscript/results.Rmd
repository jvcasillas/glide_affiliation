...
Figure \@ref(fig:plot-carrier-task-duration) shows stuff. 

(ref:plot-carrier-task-duration) This is a figure caption.

```{r, 'plot-carrier-task-duration', out.width="100%", fig.cap="(ref:plot-carrier-task-duration)"}
